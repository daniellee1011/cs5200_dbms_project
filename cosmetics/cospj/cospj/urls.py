...
urlpatterns = [
    ...
    path('deletereview/<int:product_id>/<int:userreview_id>',
         cosapp.views.deleteReview, name='delete_review'),
    path('editreview/<int:product_id>/<int:userreview_id>',
         cosapp.views.editReview, name='edit_review'),
    ...
    path('deleteproduct/<int:id>',
         cosapp.views.deleteProduct, name='delete_product'),
    path('productdetail/<int:id>', cosapp.views.productDetail, name='productdetail'),
    path('productdetail/<str:name>',
         cosapp.views.productdetail_name, name='productdetail-name'),
    ...
    path('productlist/', cosapp.views.product_list, name='productlist'),
]
